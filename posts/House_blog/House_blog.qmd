...
![](pop_ind.jpg "Title: Population"){fig-alt="Population"}

![](puma.jpg "Title: Pumas"){fig-alt="Pumas"}

![](med_age.png "Title: Median Age"){fig-alt="Median Age"}

![](med_income.png "Title: Median Income"){fig-alt="Median Income"}

![](percent_unemploy.png "Title: Unemployed"){fig-alt="Unemployed"}

![](des_moines_metro.jpg "Title: Metro circle"){fig-alt="Metro Circle"}
