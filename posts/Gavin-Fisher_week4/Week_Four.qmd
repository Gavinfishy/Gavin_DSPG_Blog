...
![](streetview.png "2009 Google Streetview")
...
Finally I made a little diagram to plan out what the algorithm will do that we are trying to build utilizing the AI models we plan to make (hopefully next week we can start cranking some out)


![](Endgame model code plan.png "google images")
